...
M.groups = function()
	...
	return {
		...
		["Constant"]  = { fg = c['ma'], bg = 'NONE' },
		["String"]    = { fg = c['gr-2'], bg = 'NONE' },
		["Character"] = { fg = c['gr-2'], bg = 'NONE' },
		["Number"]    = { fg = c['ma'], bg = 'NONE' },
		["Boolean"]   = { fg = c['ma'], bg = 'NONE' },
		["Float"]     = { fg = c['ma'], bg = 'NONE' },

		["Identifier"] = { fg = c['cy'], bg = 'NONE' },
		["Function"]   = { fg = c['ye'], bg = 'NONE' },

		["Statement"]   = { fg   = 'NONE',    bg = 'NONE'   },
		["Conditional"] = { link = 'Keyword'                },
		["Repeat"]      = { link = 'Keyword'                },
		["Label"]       = { link = 'Keyword'                },
		["Operator"]    = { fg   = c['tx'], bg   = 'NONE' },
		["Keyword"]     = { fg   = c['re-2'],   bg   = 'NONE' },
		["Exception"]   = { link = 'Keyword'                },

		["PreProc"]   = { fg = c['or-2'], bg = 'NONE' },
		["Include"]   = { fg = c['re'], bg = 'NONE' },
		["Define"]    = { fg = c['or-2'], bg = 'NONE' },
		["Macro"]     = { fg = c['or-2'], bg = 'NONE' },
		["PreCondit"] = { fg = c['or-2'], bg = 'NONE' },

		["Type"]         = { fg = c['bl'],   bg = 'NONE' },
		["StorageClass"] = { fg = c['ma-2'],   bg = 'NONE' },
		["Structure"]    = { fg = c['ma-2'],   bg = 'NONE' },
		["Typedef"]      = { fg = c['ma-2'],   bg = 'NONE' },

		["SpecialComment"] = { fg   = c['tx'],   bg = 'NONE'                },
		["Special"]        = { fg   = c['tx-2'], bg = 'NONE'                },
		["SpecialChar"]    = { fg   = c['or-2'],   bg = 'NONE'                },
		["Tag"]            = { fg   = c['cy'],   bg = 'NONE'                },
		...
		-- Pop-up menu
		["Pmenu"]      = { fg = c['tx-2'], bg = c['bg-2'], sp = 'NONE', blend = 25, },
		...
		["NormalFloat"]    = { fg = c['tx-2'], bg = c['bg-2'], blend = 25 },
